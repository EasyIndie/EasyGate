...
function Cleanup-Native {
  param([bool]$Purge)
  foreach ($Name in @("native-cloudflared", "native-traefik", "native-demo-api", "native-demo-test-api")) {
    Stop-PidFile (Join-Path $EasyGateHome "run\$Name.pid")
  }
